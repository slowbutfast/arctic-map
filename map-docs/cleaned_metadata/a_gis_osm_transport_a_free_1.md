# **Iceland Transport A (polygon)**

**Theme:** Infrastructure
**Subtheme:** Transportation
**Layer Name in Database:** `a_gis_osm_transport_a_free_1`
...
3. Check the box next to **Iceland Transport A (polygon)** to display it on the map.

--- 

**Title:** gis_osm_transport_a_free_1  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| gis_osm_transport_a_free_1 | WGS 1984 | Shapefile, Polygon | 692 | 6 | FID | double |  |
|  |  |  |  |  | Shape | Polygon |  |
|  |  |  |  |  | osm_id | Text (12) | Long identifying number code |
|  |  |  |  |  | code | Short | One of many 4-digit classifying codes beginning with 56 |
|  |  |  |  |  | fclass | Text (28) | Airfield, Airport, apron, bus_station, ferry_terminal, helipad, or taxi. Corresponds to code attribute.  |
