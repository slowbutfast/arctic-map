# **Alaska A Places of Worship (polygon)**

**Theme:** Socioeconomic
**Subtheme:** Human Settlements
**Layer Name in Database:** `a_gis_osm_pofw_a_free_1`
...
3. Check the box next to **Alaska A Places of Worship (polygon)** to display it on the map.

--- 

**Title:** gis_osm_pofw_a_free_1  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| gis_osm_pofw_a_free_1 | WGS 1984 | Shapefile, Polygon | 383lu | 6 | FID | double |  |
|  |  |  |  |  | Shape | Polygon |  |
