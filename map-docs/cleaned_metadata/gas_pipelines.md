...
**Subtheme:** Energy
**Layer Name in Database:** `gas_pipelines`
...
3. Check the box next to **Gas Pipelines** to display it on the map.
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| gas_pipelines.shp | WGS 1984 | Shapefile | 3,908 | 48 | FID | Object ID |  |
|  |  |  |  |  | Shape | Geometry |  |
