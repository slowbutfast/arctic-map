# **SSP585 Shipping Routes Worst Case Emissions Scenario**

**Theme:** Infrastructure
**Subtheme:** Transportation
**Layer Name in Database:** `route_SSP585_worst_case_emissions`
...
3. Check the box next to **SSP585 Shipping Routes Worst Case Emissions Scenario** to display it on the map.

--- 

**Title:** route_SSP585_worst_case_emissions  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| route_SSP585_moderate_emissions.shp | North_Pole_Lambert_Azimuthal_Equal_Area | Shapefile | 73,615 | 7 | FID | OID |  |
|  |  |  |  |  | Shape | Geometry |  |
|  |  |  |  |  | Id | Integer |  |
|  |  |  |  |  | Year | String |  |
|  |  |  |  |  | Month | String |  |
