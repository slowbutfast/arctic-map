# **Alaska Traffic (point)**

**Theme:** Infrastructure
**Subtheme:** Transportation
**Layer Name in Database:** `a_gis_osm_traffic_free_1`
...
3. Check the box next to **Alaska Traffic (point)** to display it on the map.

--- 

**Title:** gis_osm_traffic_free_1  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| gis_osm_traffic_free_1 | WGS 1984 | Shapefile, Point | 19,288 | 6 | FID | double |  |
|  |  |  |  |  | Shape | Point |  |
|  |  |  |  |  | osm_id | Text (12) | Long identifying number code |
|  |  |  |  |  | code | Short | One of many 4-digit classifying codes beginning with 5 |
|  |  |  |  |  | fclass | Text (28) | Pier, dam, parking, fuel, stop, speed_cam, marina, etc. Corresponds to code attribute.  |
