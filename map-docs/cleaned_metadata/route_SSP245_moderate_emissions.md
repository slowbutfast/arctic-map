# **SSP245 Shipping Routes Moderate Emissions Scenario**

**Theme:** Infrastructure
**Subtheme:** Transportation
**Layer Name in Database:** `route_SSP245_moderate_emissions`
...
3. Check the box next to **SSP245 Shipping Routes Moderate Emissions Scenario** to display it on the map.

--- 

**Title:** route_SSP245_moderate_emissions  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| route_SSP245_moderate_emissions.shp | North_Pole_Lambert_Azimuthal_Equal_Area | Shapefile | 66,052 | 7 | FID | OID |  |
|  |  |  |  |  | Shape | Geometry |  |
|  |  |  |  |  | Id | Integer |  |
|  |  |  |  |  | Year | String |  |
|  |  |  |  |  | Month | String |  |
