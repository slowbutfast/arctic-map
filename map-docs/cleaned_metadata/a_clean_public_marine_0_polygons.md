# **Public Marine Polygons**

**Theme:** Environmental
**Subtheme:** Water Resources
**Layer Name in Database:** `a_clean_public_marine_0_polygons`
...
3. Check the box next to **Public Marine Polygons** to display it on the map.

--- 

**Title**: a_clean_public_marine_0_polygons  
...
**Lineage:** The fields: Supp_Info and Cons_obj etc are removed because these attributes are blank. 
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| a_clean_public_marine_0_polygons.shp | WGS 1984 | Polygon | 6112 | 30 | FID | Object ID |  |
|  |  |  |  |  | Shape | Geometry |  |
|  |  |  |  |  | WDPAID | Double | “Assigned by UNEP-WCMC. Unique identifier for a protected Area. “ |
|  |  |  |  |  | WDPA_PID | Text | “Assigned by UNEP-WCMC. Unique identifier for parcels or zones within a protected area “ |
...
|  |  |  |  |  | DESIG_ENG | Text | Name of designation in english |
|  |  |  |  |  | DESIG_TYPE | Text | “Allowed values: National, Regional, International, Not Applicable” |
|  |  |  |  |  | IUCN_CAT | Text | “Allowed values: Ia, Ib, II, III, IV, V, VI, Not Applicable, Not Assigned, Not Reported” (not sure what this means) |
|  |  |  |  |  | INT_CRIT | Text | “Assigned by UNEP-WCMC. For World Heritage and Ramsar sites only.” –written in numerals |
...
|  |  |  |  |  | GIS_M_AREA | Double | “Assigned by UNEP-WCMC.” |
|  |  |  |  |  | REP_AREA | Double | “Area in square kilometres. “ |
|  |  |  |  |  | GIS_AREA | Double | “Assigned by UNEP-WCMC.” |
|  |  |  |  |  | NO_TAKE | Text | “Allowed values: All, Part, None, Not Reported, Not Applicable (if no marine component).” |
|  |  |  |  |  | NO_TK_AREA | Text | “Area of the no-take area in square kilometres.” |
...
|  |  |  |  |  | MANG_AUTH | Text | “Individual or group that manages the protected area.” |
