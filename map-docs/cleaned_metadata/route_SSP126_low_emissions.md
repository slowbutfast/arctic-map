# **SSP126 Shipping Routes Low Emissions Scenario**

**Theme:** Infrastructure
**Subtheme:** Transportation
**Layer Name in Database:** `route_SSP126_low_emissions`
...
3. Check the box next to **SSP126 Shipping Routes Low Emissions Scenario** to display it on the map.

--- 

**Title:** route_SSP126_low_emissions  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| route_SSP126_low_emissions.shp | North_Pole_Lambert_Azimuthal_Equal_Area | Shapefile | 64,094 | 7 | FID | OID |  |
|  |  |  |  |  | Shape | Geometry |  |
|  |  |  |  |  | Id | Integer |  |
|  |  |  |  |  | Year | String |  |
|  |  |  |  |  | Month | String |  |
