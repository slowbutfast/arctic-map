# **Alaska Places of Interest (point)**

**Theme:** Socioeconomic
**Subtheme:** Human Settlements
**Layer Name in Database:** `a_gis_osm_pois_free_1`
...
3. Check the box next to **Alaska Places of Interest (point)** to display it on the map.
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| gis_osm_pois_free_1 | WGS 1984 | Shapefile, Point | 4575 | 6 | FID | double |  |
|  |  |  |  |  | Shape | Point |  |
|  |  |  |  |  | osm_id | Text (12) | Long identifying number code |
|  |  |  |  |  | code | Short | One of many unique 4-digit identifying codes beginning with 2\. |
|  |  |  |  |  | fclass | Text (28) | Describes the business or public place type (bakery, chemist, artwork, university, water_well, zoo, etc) |
