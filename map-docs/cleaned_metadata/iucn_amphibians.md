...
**Layer Name in Database:** `iucn_amphibians`
...
3. Check the box next to **Amphibian Species** to display it on the map.

--- 

**Title:** iucn_amphibians  
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| iucn_amphibians.shp | WGS 1984 | Shapefile | 26 | 32 | FID | OID |  |
|  |  |  |  |  | Shape | Geometry |  |
|  |  |  |  |  | id_no | Integer |  |
|  |  |  |  |  | sci_name | String |  |
|  |  |  |  |  | presence | Integer |  |
